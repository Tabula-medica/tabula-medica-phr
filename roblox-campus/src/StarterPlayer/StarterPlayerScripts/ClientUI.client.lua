-- ClientUI.client.lua
-- Minimal starter UI for Campus Life: a link panel, a Nova scorecard panel,
-- and a reward toast. Same wiring pattern as the kids' World Clinic —
-- replace with real UI/UX art before shipping.
...
title.Text = "LINK UP // Tabula Medica"
...
-- Nova panel (Campus Life scorecard) ---------------------------------------
...
novaFrame.BackgroundColor3 = Color3.fromRGB(18, 32, 42)
...
novaTitle.Text = "NOVA // Campus Life"
...
RemoteEvents.CampusScorecardUpdated.OnClientEvent:Connect(function(scorecard)
...
RemoteEvents.RewardEarned.OnClientEvent:Connect(function(payload)
	...
	toast.BackgroundColor3 = Color3.fromRGB(24, 26, 36)
