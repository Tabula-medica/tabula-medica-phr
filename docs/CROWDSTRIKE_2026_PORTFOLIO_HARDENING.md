...
| **Per-PR + daily dependency scan** (OSV-Scanner + `npm audit --audit-level=high`) | ✅ `.github/workflows/security-scan.yml` | 🔁 | 🔁 | 🔁 | 🔁 |
...
| `.github/workflows/security-scan.yml` | OSV-Scanner + `npm audit` on PR, push to `main`, and daily 06:17 UTC; runs the three new security test suites. | On |
...
- `.github/workflows/security-scan.yml` — unchanged.
