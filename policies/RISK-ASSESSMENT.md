...
| R-04 | **Supply-Chain Vulnerability** — Compromise via third-party dependency introducing malicious code or exploitable CVE into PHI-handling systems | 2 | 2 | **4 — MEDIUM** | Dependabot auto-PRs; container image scanning; lock-file pinning; vendor BAA register; critical CVE SLA 30 days | Low (2) | Engineering Lead |
