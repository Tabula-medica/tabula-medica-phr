...
export const FHIR_PRESETS: Record<EhrPlatform, FhirEndpointPreset> = {
  fastenhealth: {
    ...
    name: "Fasten Health",
    sandboxConfig: {
      fhirBaseUrl: "https://api.fastenhealth.com/v1/fhir",
      authorizationEndpoint: "https://api.fastenhealth.com/v1/oauth/authorize",
      tokenEndpoint: "https://api.fastenhealth.com/v1/oauth/token",
      issuer: "https://api.fastenhealth.com",
