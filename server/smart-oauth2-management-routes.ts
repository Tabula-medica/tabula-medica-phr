...
export function registerSmartOAuth2ManagementRoutes(app: Express): void {
  ...
  app.get(`${prefix}/tokens/analytics`, requireUser, async (_req: Request, res: Response) => {
    try {
  ...
  app.get(`${prefix}/tokens`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${prefix}/tokens/:tokenId`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${prefix}/tokens/introspect`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${prefix}/tokens/:tokenId/refresh`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${prefix}/tokens/:tokenId/revoke`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${prefix}/tokens/revoke-all`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${prefix}/tokens/expiring`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${prefix}/sessions`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${prefix}/sessions/:sessionId/terminate`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${prefix}/clients`, requireUser, async (_req: Request, res: Response) => {
    try {
  ...
  app.get(`${prefix}/clients/:clientId`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.put(`${prefix}/clients/:clientId`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${prefix}/activities`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${prefix}/cleanup`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${scopePrefix}/stats`, requireUser, async (_req: Request, res: Response) => {
    try {
  ...
  app.get(`${scopePrefix}/definitions`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${scopePrefix}/definitions`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${scopePrefix}/configurations`, requireUser, async (_req: Request, res: Response) => {
    try {
  ...
  app.get(`${scopePrefix}/configurations/:appId`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${scopePrefix}/configurations`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.put(`${scopePrefix}/configurations/:configId`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${scopePrefix}/configurations/:configId/grant`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${scopePrefix}/configurations/:configId/deny`, requireUser, async (req: Request, res: Response) => {
    try {
      const { scopes } = req.body;
  ...
  app.post(`${scopePrefix}/configurations/:configId/rules`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.delete(`${scopePrefix}/configurations/:configId/rules/:ruleId`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${scopePrefix}/configurations/:configId/restrictions`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${scopePrefix}/validate`, requireUser, async (req: Request, res: Response) => {
    try {
      const { scopes } = req.body;
  ...
  app.get(`${scopePrefix}/templates`, requireUser, async (_req: Request, res: Response) => {
    try {
  ...
  app.post(`${scopePrefix}/configurations/:configId/apply-template`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.put(`${scopePrefix}/configurations/:configId/auth-params`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.put(`${scopePrefix}/configurations/:configId/consent-policy`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${accessPrefix}/analytics`, requireUser, async (_req: Request, res: Response) => {
    try {
  ...
  app.get(`${accessPrefix}/events`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${accessPrefix}/events`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${accessPrefix}/patterns`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${accessPrefix}/patterns/:patternId/acknowledge`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${accessPrefix}/apps`, requireUser, async (_req: Request, res: Response) => {
    try {
  ...
  app.get(`${accessPrefix}/apps/:appId`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${accessPrefix}/apps/:appId/permissions`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.get(`${accessPrefix}/apps/:appId/trends`, requireUser, async (req: Request, res: Response) => {
    try {
  ...
  app.post(`${accessPrefix}/apps/:appId/revoke`, requireUser, async (req: Request, res: Response) => {
    try {
      const { reason } = req.body;
  ...
  app.put(`${accessPrefix}/apps/:appId/permissions`, requireUser, async (req: Request, res: Response) => {
    try {
      const { grantedScopes, deniedScopes } = req.body;
