...
function initializeSampleData() {
  const conv1: Conversation = {
    ...
    participants: [
      { id: "demo-patient-001", name: "John Smith", role: "patient", status: "online" },
  ...
  const doc1: SharedDocument = {
    ...
    accessLog: [
      { accessedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), accessedBy: "demo-patient-001", accessType: "view" },
      { accessedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), accessedBy: "demo-patient-001", accessType: "download" },
    ],
