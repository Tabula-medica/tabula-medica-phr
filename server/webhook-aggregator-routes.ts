...
const webhookEvents: WebhookEvent[] = [
  {
    ...
    payload: { patientId: "demo-patient-001", resourceType: "Patient", action: "update" },
  ...
  },
  {
    ...
    payload: { patientId: "demo-patient-001", resourceType: "MedicationRequest", action: "update" },
  ...
  },
  {
    ...
    payload: { patientId: "demo-patient-001", resourceType: "AllergyIntolerance", action: "create" },
